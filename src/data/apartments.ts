  ...
  },
  {
    ...
    translations: {
      sl: {
        ...
        amenities: ['Popolnoma opremljena kuhinja', 'Kopalnica', 'WC', 'Klimatska naprava - bivalna', 'Klimatska naprava - kabinska', 'Ogrevanje - plin - klima', 'Sončne celice', 'Hladilnik'],
        location: 'Pohorje, Maribor'
      },
      en: {
        ...
        amenities: ['Fully equipped kitchen', 'Bathroom', 'WC', 'Air conditioning - living area', 'Air conditioning - cabin', 'Heating - gas - climate', 'Solar panels', 'Refrigerator'],
        location: 'Pohorje, Maribor'
      },
      de: {
        ...
        amenities: ['Komplett ausgestattete Küche', 'Badezimmer', 'WC', 'Klimaanlage - Wohnbereich', 'Klimaanlage - Kabine', 'Heizung - Gas - Klima', 'Solarzellen', 'Kühlschrank'],
        location: 'Pohorje, Maribor'
      }
    },
    price: 99,
