...
export const apartments: Apartment[] = [
  {
    ...
    translations: {
      sl: {
        ...
        amenities: ['Opremljena kuhinja', 'Razgled na mesto', 'Vrt', 'Hišnim ljubljenčkom prijazno', 'Brezplačen WiFi', 'Ograjena terasa (32m²) z mizo in stoli', 'Kamin', 'Ležalniki', 'Brezplačno parkirišče', 'Zasebna kopalnica', 'Sobe za nekadilce'],
      ...
      en: {
        ...
        amenities: ['Kitchen', 'City view', 'Garden', 'Pet friendly', 'Free WiFi', 'Fenced terrace (32m²) with table and chairs', 'Fireplace', 'Sun loungers', 'Free parking', 'Private bathroom', 'Non-smoking rooms'],
        location: 'Pohorje, Maribor'
      },
      de: {
        title: 'Apartment Pohorc - Macesen',
        ...
        amenities: ['Ausgestattete Küche', 'Stadtblick', 'Garten', 'Haustierfreundlich', 'Kostenloses WLAN', 'Eingezäunte Terrasse (32m²) mit Tisch und Stühlen', 'Kamin', 'Sonnenliegen', 'Kostenlose Parkplätze', 'Eigenes Bad', 'Nichtraucherzimmer'],
        location: 'Pohorje, Maribor'
      }
    },
    price: 119,
