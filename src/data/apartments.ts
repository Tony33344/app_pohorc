...
export const apartments: Apartment[] = [
  {
    ...
    translations: {
      sl: {
        ...
        amenities: ['Opremljena kuhinja', 'Razgled na mesto', 'Vrt', 'Hišnim ljubljenčkom prijazno', 'Brezplačen WiFi', 'Terasa 1 (24m²) z ograjo, mizo in stoli', 'Terasa 2 (28m²)', 'Kamin', 'Ležalniki', 'Brezplačno parkirišče', 'Zasebna kopalnica', 'Sobe za nekadilce'],
      ...
      en: {
        ...
        amenities: ['Kitchen', 'City view', 'Garden', 'Pet friendly', 'Free WiFi', 'Terrace 1 (24m²) with fence, table and chairs', 'Terrace 2 (28m²)', 'Fireplace', 'Sun loungers', 'Free parking', 'Private bathroom', 'Non-smoking rooms'],
        location: 'Pohorje, Maribor'
      },
      de: {
        title: 'Apartment Pohorc - Macesen',
        ...
        amenities: ['Ausgestattete Küche', 'Stadtblick', 'Garten', 'Haustierfreundlich', 'Kostenloses WLAN', 'Terrasse 1 (24m²) mit Zaun, Tisch und Stühlen', 'Terrasse 2 (28m²)', 'Kamin', 'Sonnenliegen', 'Kostenlose Parkplätze', 'Eigenes Bad', 'Nichtraucherzimmer'],
        location: 'Pohorje, Maribor'
      }
    },
    price: 119,
  ...
  },
  {
    ...
    translations: {
      sl: {
        ...
        amenities: ['Celoten apartma', 'Opremljena kuhinja', 'Razgled na mesto', 'Vrt', 'Hišnim ljubljenčkom prijazno', 'Zunanji žar', 'Brezplačen WiFi', 'Terasa (28m²)', 'Terasa (24m²)', 'Ležalniki', 'Balkon'],
        location: 'Pohorje, Maribor'
      },
      en: {
        ...
        amenities: ['Entire place', 'Kitchen', 'City view', 'Garden', 'Pet friendly', 'BBQ facilities', 'Free WiFi', 'Terrace (28m²)', 'Terrace (24m²)', 'Sun loungers', 'Balcony'],
        location: 'Pohorje, Maribor'
      },
      de: {
        title: 'Apartment Pohorc - Kostanj',
        ...
        amenities: ['Gesamte Unterkunft', 'Ausgestattete Küche', 'Stadtblick', 'Garten', 'Haustierfreundlich', 'Grillmöglichkeiten', 'Kostenloses WLAN', 'Terrasse (28m²)', 'Terrasse (24m²)', 'Sonnenliegen', 'Balkon'],
        location: 'Pohorje, Maribor'
      }
    },
    price: 260,
  ...
  },
  {
    ...
    translations: {
      sl: {
        ...
        amenities: ['Popolnoma opremljena kuhinja', 'Kopalnica', 'WC', 'Klimatska naprava - bivalna', 'Klimatska naprava - kabinska', 'Ogrevanje - plin - klima', 'Sončne celice', 'Hladilnik', 'Zmrzovalnik'],
        location: 'Pohorje, Maribor'
      },
      en: {
        ...
        amenities: ['Fully equipped kitchen', 'Bathroom', 'WC', 'Air conditioning - living area', 'Air conditioning - cabin', 'Heating - gas - climate', 'Solar panels', 'Refrigerator', 'Freezer'],
        location: 'Pohorje, Maribor'
      },
      de: {
        ...
        amenities: ['Komplett ausgestattete Küche', 'Badezimmer', 'WC', 'Klimaanlage - Wohnbereich', 'Klimaanlage - Kabine', 'Heizung - Gas - Klima', 'Solarzellen', 'Kühlschrank', 'Gefrierschrank'],
        location: 'Pohorje, Maribor'
      }
    },
    price: 99,
